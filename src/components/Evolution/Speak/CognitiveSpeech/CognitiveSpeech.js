...
(function (CognitiveSpeech) {
  ...
  })(CognitiveSpeech.OutputFormat || (CognitiveSpeech.OutputFormat = {}));
  var OutputFormat = CognitiveSpeech.OutputFormat;
  ;
  (function (SupportedLocales) {
      ...
      SupportedLocales[SupportedLocales["hiIN_Male"] = 28] = "hiIN_Male";
  })(CognitiveSpeech.SupportedLocales || (CognitiveSpeech.SupportedLocales = {}));
  var SupportedLocales = CognitiveSpeech.SupportedLocales;
  class Tools {
      /**
      ...
      */
      constructor(apiKey) {
          ...
          if (!apiKey) {
              throw new Error('Please provide a valid Bing Speech API key');
          }
          this.apiKey = apiKey;
          try {
  ...
  class RecognitionClient {
      ...
      */
      constructor(apiKey, locale = "en-us") {
          ...
          this._vad = null;
          this._isSafari =  navigator.vendor && navigator.vendor.indexOf('Apple') > -1 &&
             navigator.userAgent &&
          ...
          if (!navigator.getUserMedia && !this._isSafari) {
              //this._isSafari = true;
              //navigator.getUserMedia = navigator.mediaDevices.getUserMedia ;
               throw new Error("Sorry, your browser doesn't have microphone support. "+navigator.mediaDevices.getUserMedia);
          }
      }
      ...
      _continueListening() {
          if(!this._isSafari){
            ...
            navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then((stream) => {
              ...
              // rejection
                console.log("No live audio input in this browser: " + reason);
            });
          }
      ...
      recognizeAudio(audio, locale) {
          return __awaiter(this, void 0, void 0, function* () {
              ...
              try {
                  ...
                  var requestParameters = "?format=simple&appid=D4D52672-91D7-4C74-8AD8-42B1D98141A5&language=" + this._locale + "&device.os=wp7&version=3.0&format=json&instanceid=b2c95ede-97eb-4c88-81e4-80f32d6aee54&requestid=" + requestId;
                  ...
                  response = yield this._tools.makeHttpRequest("POST", "https://westus.stt.speech.microsoft.com/speech/recognition/dictation/cognitiveservices/v1" + requestParameters, false, optionalHeaders, blob);
                  var parsedReponse = JSON.parse(response);
                  if (parsedReponse.RecognitionStatus === "Success" ) {
                      textAnswer = parsedReponse.DisplayText;
                  } else if (parsedReponse.RecognitionStatus === "NoMatch" ) {
                    console.log('No Match');
                      textAnswer = "";
                  }
                  else {
                      error = true;
                      textAnswer = "!Error during recognition!"+JSON.stringify(parsedReponse);
                  }
                  let index = 0;
  ...
  CognitiveSpeech.RecognitionClient = RecognitionClient;
  class TTSClient {
      /**
      * @param apiKey should be your Bing Speech API key
      * Note: The way to get api key:
      ...
      synthesize(text, locale, callback, outputFormat = OutputFormat.Riff16khz16bit) {
          return __awaiter(this, void 0, void 0, function* () {
              ...
              if (this.multipleXHR || this._requestsInProgress === 0) {
                  this._getCognitiveSpeechData(text, locale, outputFormat, speechItemIndex);
              }
          });
      }
      _getCognitiveSpeechData(text, locale, outputFormat, speechItemIndex) {
          return __awaiter(this, void 0, void 0, function* () {
              ...
              if (!this.multipleXHR && (nextIndex < this._waitingQueue.length)) {
                  this._getCognitiveSpeechData(this._waitingQueue[nextIndex].text, this._waitingQueue[nextIndex].locale, this._waitingQueue[nextIndex].outputFormat, this._waitingQueue[nextIndex].index);
              }
              if (!this._playing) {
                  this._play();
              }
  ...
  CognitiveSpeech.TTSClient = TTSClient;
})(CognitiveSpeech || (CognitiveSpeech = {}));
if (!String.prototype.encodeHTML) {
  String.prototype.encodeHTML = function () { /*eslint no-extend-native: ["error", { "exceptions": ["String"] }]*/
...
//# sourceMappingURL=CognitiveSpeech.js.map
export default CognitiveSpeech;